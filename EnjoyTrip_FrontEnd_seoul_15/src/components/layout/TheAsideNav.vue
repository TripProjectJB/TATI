    ...
    <div class="inner">
      ...
      <section>
        ...
        <div class="row 50% uniform">
          ...
          <div class="4u$" v-if="userInfo.userId">
            ...
            <ul class="actions">
              <li>
                <button @click="$router.push({ name: 'mypage' })">
                  MyPage
                </button>
              </li>
            </ul>
      ...
      <nav id="menu">
        ...
        <ul>
          ...
          <li>
            <RouterLink :to="{ name: 'map-main', params: { no: '0' } }"
              >관광지 검색</RouterLink
            >
          </li>
          <li>
      ...
      <section>
        ...
        <ul class="contact">
          <li class="icon fa-user">
            이제헌 / 컴퓨터공학 /
            <a class="icon fa-github" @click="git(0)"
              >&nbsp;&nbsp;github.com/JEGHTNER</a
            >
          </li>
          <li class="fa-user">
            김종범 / 물리학과 /
            <a class="icon fa-github" @click="git(1)"
              >&nbsp;&nbsp;github.com/jongbum97</a
            >
          </li>
