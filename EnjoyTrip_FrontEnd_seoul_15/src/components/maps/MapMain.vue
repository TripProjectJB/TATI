...
<template>
    <div class="row mb-5 justify-content-center">
        <div class="col-lg-6 text-center">
            <h1 class="section-title text-center mb-3 mt-5">전국의 관광지 정보 조회</h1>
            <p>
    ...
    <div class="row" style="overflow: scroll; width: auto; height: 1000px">
        <table class="table table-striped mt-3">
            ...
            <tbody>
                <tr v-for="area in trips" :key="area.title" class="trip-info" @click="moveCenter(area.mapy, area.mapx)">
