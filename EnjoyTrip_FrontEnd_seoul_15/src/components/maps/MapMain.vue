        ...
        const iwContent = `
            <div style="width:330px; text-align: center">
             <div class="title" style="font-size: x-large; font-weight: bold;">
              ...
              <div>
                  <img src="${positions.value[i].firstimage || altImage}" width="180" height="100" />
                  <div class="desc">
    ...
    const content = `
            <div style="width:330px; text-align: center">
             <div id="detailLink" class="title" style="font-size: x-large; font-weight: bold;">
              ...
              <div>
                  <img src="${positions.value[index].firstimage || altImage}" width="180" height="100" />
                  <div class="desc">
...
<template>
    <div class="row mb-5 justify-content-center">
        <div class="col-lg-6 text-center">
            <h1 class="section-title text-center mb-3 mt-5 icon fa-map">&nbsp; 전국의 관광지 정보 조회</h1>
            <p>
    ...
    <form class="search_travel_input d-flex" onsubmit="return false;" role="search">
        <ul class="row actions">
            ...
            <li class="1u$">
                <button id="btn-search" class="col-2 btn btntheme" type="button" @click="btnSearch">검색</button>
            </li>
        </ul>
    </form>
    <!-- kakao map start -->
