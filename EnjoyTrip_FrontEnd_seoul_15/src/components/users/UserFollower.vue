...
<template>
    <h1 style="text-align: center">{{ route.params.userid }}님의 Follower : {{ thisUserFollowerCount }}</h1>
    ...
    <div id="grid">
        <slot-comp v-for="id in thisUserFollower">
            ...
            <button v-if="id.isFollowing" style="font-size: small" @click="followCancel(id)">팔로우 취소</button>
